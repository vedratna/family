...
Reusable GraphQL-based test data factories for the Playwright E2E suite. Enables tests to reach a given app state (authenticated user, populated family, pending invitation) without stepping through the UI.
