...
> A shared calendar for birthdays, anniversaries, exams, social functions, and more.
...
Toggle **"Repeat annually"** for events that happen every year (birthdays, anniversaries). The system automatically creates next year's event for you.
...
The event shows how many people are going.
...
You can customize which reminders you receive in **Settings > Notifications**.
