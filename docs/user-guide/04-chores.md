...
> Assign, track, and rotate household tasks.
...
Tap the checkbox next to a chore to mark it complete. Completed chores show with a strikethrough and green checkmark.
...
```
Week 1: Rajesh (takes out trash)  ✓
Week 2: Priya  (takes out trash)  ✓
Week 3: Amit   (takes out trash)  ← current
Week 4: Rajesh (rotation restarts)
```
